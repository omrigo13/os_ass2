...
struct stat;
struct superblock;
struct sigaction; // task 2.1.4
struct thread; // task 3
...
int             sigaction(int, const struct sigaction*, struct sigaction*); // task 2.1.4 register handler for a specific signal
void            sigret(void); // task 2.1.5
void            handle_signals(void); // task 2.4
int             kthread_create( void ( *start_func ) ( ), void *stack ); // task 3.2, creates a new thread within the context of the calling process
int             kthread_id(); // task 3.2, returns the caller thread's id
...
void            init_binary_semaphores(void); // task 4 init the array of binary semaphores
